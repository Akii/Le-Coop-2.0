...
/**
 * Test case for class Tx_Lecoop_Domain_Model_Tag.
 *
 * @version $Id$
 ...
 */
class Tx_Lecoop_Domain_Model_TagTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_Lecoop_Domain_Model_Tag
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_Lecoop_Domain_Model_Tag();
	}
