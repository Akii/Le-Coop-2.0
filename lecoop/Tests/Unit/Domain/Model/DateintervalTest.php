...
/**
 * Test case for class Tx_Lecoop_Domain_Model_Dateinterval.
 *
 * @version $Id$
 ...
 */
class Tx_Lecoop_Domain_Model_DateintervalTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_Lecoop_Domain_Model_Dateinterval
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_Lecoop_Domain_Model_Dateinterval();
	}
