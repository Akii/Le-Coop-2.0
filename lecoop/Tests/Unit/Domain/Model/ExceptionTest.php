...
/**
 * Test case for class Tx_Lecoop_Domain_Model_Exception.
 *
 * @version $Id$
 ...
 */
class Tx_Lecoop_Domain_Model_ExceptionTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_Lecoop_Domain_Model_Exception
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_Lecoop_Domain_Model_Exception();
	}
	...
	public function setReasonForStringSetsReason() { 
		$this->fixture->setReason('Conceived at T3CON10');

		$this->assertSame(
			'Conceived at T3CON10',
			$this->fixture->getReason()
		);
	}
