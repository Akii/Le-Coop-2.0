...
/**
 * Test case for class Tx_Lecoop_Controller_ScheduleController.
 *
 * @version $Id$
 ...
 */
class Tx_Lecoop_Controller_ScheduleControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
